...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.share-button').each(function (_i, shareButton) {
  var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(shareButton);
  button.on('click', function () {
    var postId = jquery__WEBPACK_IMPORTED_MODULE_0___default()(button).data('post-id');
    var shareUrl = "".concat(location.origin, "/posts/").concat(postId);
    console.log(shareUrl);
    navigator.clipboard.writeText(shareUrl).then(function () {
      button.html("<i class=\"bi bi-bookmark-check\">Copied!</i>");
      setTimeout(function () {
        return button.html("<i class=\"bi bi-share-fill\">\u5171\u6709</i>");
      }, 1000);
    });
  });
});
